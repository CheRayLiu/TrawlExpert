...
public class DataStore {
	...
	public static void init(Record[] recs) {
		...
		GeneralCompare<Record> ax2 = (r0,r1) -> Double.compare(((Record) r0).getLatitude(), ((Record) r1).getLatitude());
		GeneralCompare<Record> ax3 = (r0,r1) -> Double.compare(((Record) r0).getLongitude(), ((Record) r1).getLongitude());
